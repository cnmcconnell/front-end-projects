...
const myData = [
  {
    ...
    blog: '<h4> Location: </h4> Chimney Rock State Park <br> <h4> Time: </h4> Daily 2-2:30 p.m. <br>'
  },
  {
    title: 'Greenville Drive Game',
    blog: '<h4> Location: </h4> Fluor Field at West End <br> <h4> Time: </h4> Varies <br>'
  },
  {
    title: 'Happy Hour',
    blog: '<h4> Location: </h4> Joe\'s Place <br> <h4> Time: </h4> 4:30-6:30 p.m. <br> '
  },
  {
